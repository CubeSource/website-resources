    ...
    <footer className="text-white pt-20 pb-16 font-sans relative z-10">
      <div className="mx-auto max-w-[1400px] px-6 lg:px-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-3 flex flex-col justify-between h-full min-h-[200px] space-y-8">
            {/* Logo */}
            <div className="flex items-center gap-3">
               <svg preserveAspectRatio="xMidYMid meet" data-bbox="50.186 24.788 99.488 149.999" viewBox="50.186 24.788 99.488 149.999" className="h-14 w-auto" xmlns="http://www.w3.org/2000/svg" data-type="tint" role="presentation" aria-hidden="true" aria-label="">
                <g>
